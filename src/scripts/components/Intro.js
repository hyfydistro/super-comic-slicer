    ...
    return (
        <section id="intro">
            <div className="intro--text">
                ...
                <p>
                    <strong>Super Comic Slicer</strong> is a web application that handles artists’ long comic page and divides them within the webcomic’s constraint. It also features an option called “squash” which allows to scale down the comic size!
            </p>
                <p>
