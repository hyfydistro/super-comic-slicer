...
export default function Footer() {
    ...
    return (
        <footer>
            ...
            <div className="footer-notes"><p className="text-small">Website developed by Caroline Rozali • <a href="https://twitter.com/Spectredox">Twitter</a> • <a href="https://www.instagram.com/spectredox/">Instagram</a> • <a href="https://github.com/hyfydistro">Github</a> • 2021 • <a href="https://github.com/hyfydistro/super-comic-slicer/blob/main/LICENSE">License</a> • Version 1.0.1</p></div>
        </footer>
    )
}